...
export function createCSSTransform({ x, y, rotation }: { x: number, y: number, rotation: number }): Object {
  // Replace unitless items with px
  return { [browserPrefixToKey('transform', browserPrefix)]: 'rotate(' + rotation + 'deg) translate(' + x + 'px,' + y + 'px)' };
}

export function createSVGTransform({ x, y, rotation }: { x: number, y: number, rotation: number }): string {
